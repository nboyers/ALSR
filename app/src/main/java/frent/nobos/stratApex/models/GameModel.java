...
public class GameModel {
   ...
   "Phoenix Kits only","No healables. GLHF","Shield Batteries only","Only shield regen",
    ...
    public final String[] KINGS_CANYON = {"Crash Site",
    ...
    public final String[] OLYMPUS = {"Oasis" ,
            "Turbine" ,
            "Power Grid" ,
            "Energy Depot" ,
            "Hammond Labs" ,
            ...
            "Gardens" ,
            "Rift" ,
            "Far-Left of Phase Runner" ,
            "Estates" ,
            "Middle of Phase Runner" ,
            "Elysium" ,
            "Hydroponics" ,
            "Bonsai Plaza" ,
            "Oribtal Cannon" ,
    ...
    public final String[] WORLDS_EDGE = {"Trials" ,
            "Skyhook" ,
            "Survey Camp" ,
            "Overlook" ,
            "Fragment E" ,
